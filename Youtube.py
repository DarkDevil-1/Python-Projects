    ...
    if confo == 'y':
        ...
        if choice in choices:
            if choice.lower() == 'v':
                ...
                stream.download('/Users/YOURUSERNAME/Videos/Youtube Videos')  #Path can be anywhere make sure to use / instead of \
                print('Download complete!')
            elif choice.lower() == 'a':
                print('Downloading audio...')
                stream = yt.streams.get_audio_only()
                stream.download('/Users/YOURUSERNAME/Music/Spotify/English') #Path can be anywhere make sure to use / instead of \
                print('Download complete!')
        else:
